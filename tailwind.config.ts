...
export default {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				'graphik': ['Inter', 'sans-serif'], // Using Inter as Graphik alternative
				'publico': ['Georgia', 'serif'],    // Using Georgia as Publico Text alternative
				'druk': ['Impact', 'sans-serif'],   // Using Impact as Druk alternative
			},
			colors: {
