...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-desert-storm">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="font-publico text-lg text-lunar-green mb-6 leading-relaxed">
          ...
          <p className="font-publico text-lg text-lunar-green leading-relaxed">
