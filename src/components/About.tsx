      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg border border-gray-200 rounded-lg p-6">
          ...
          <p className="font-publico text-lg text-goldsmiths-text leading-relaxed text-justify">
            <strong>All the accepted papers of DASGRI-2026 will be published as a proceedings of DASGRI -2026 in Springer Lecture Notes in Networks & Systems (LNNS), indexed by Scopus, EI, WoS and other reputed Databases. Some papers will be invited to be submitted in Scopus and SCIE indexed Journals.</strong>
          </p>
